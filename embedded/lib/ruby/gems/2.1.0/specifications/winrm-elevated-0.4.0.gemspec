# -*- encoding: utf-8 -*-
# stub: winrm-elevated 0.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<winrm>.freeze, ["~> 1.5"])
      s.add_runtime_dependency(%q<winrm-fs>.freeze, ["~> 0.4.2"])
      s.add_development_dependency(%q<rspec>.freeze, ["~> 3.2"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.3"])
      s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.28"])
    else
      s.add_dependency(%q<winrm>.freeze, ["~> 1.5"])
      s.add_dependency(%q<winrm-fs>.freeze, ["~> 0.4.2"])
