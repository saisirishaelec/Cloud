...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<chef>.freeze, [">= 11.14"])
      s.add_runtime_dependency(%q<fauxhai>.freeze, ["~> 3.2"])
      ...
      s.add_dependency(%q<chef>.freeze, [">= 11.14"])
      s.add_dependency(%q<fauxhai>.freeze, ["~> 3.2"])
