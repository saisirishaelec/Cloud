# -*- encoding: utf-8 -*-
# stub: rubygems-update 2.6.4 ruby hide_lib_for_update
...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CODE_OF_CONDUCT.md", "CONTRIBUTING.rdoc", "CVE-2013-4287.txt", "CVE-2013-4363.txt", "CVE-2015-3900.txt", "History.txt", "LICENSE.txt", "MAINTAINERS.txt", "MIT.txt", "Manifest.txt", "POLICIES.rdoc", "README.rdoc", "UPGRADING.rdoc", "hide_lib_for_update/note.txt"]
  s.files = ["CODE_OF_CONDUCT.md", "CONTRIBUTING.rdoc", "CVE-2013-4287.txt", "CVE-2013-4363.txt", "CVE-2015-3900.txt", "History.txt", "LICENSE.txt", "MAINTAINERS.txt", "MIT.txt", "Manifest.txt", "POLICIES.rdoc", "README.rdoc", "UPGRADING.rdoc", "bin/update_rubygems", "hide_lib_for_update/note.txt"]
